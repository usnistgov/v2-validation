...
public class Detections {
     ...
     */
    public static Entry csFailure(Location errLoc, Element context, Constraint c,List<Trace> stack) {
    ...
    private static Entry csEntry(String configKey, Location errLoc, Element context,
